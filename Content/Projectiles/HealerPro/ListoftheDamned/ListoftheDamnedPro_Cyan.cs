...
{
    public class ListoftheDamnedSoul_Cyan : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            // Optional: add trail cache length if you want smoother trail updates
        ...
        public override void AI()
        {
            ...
            // Base dust (always)
            int baseDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.BlueTorch, 0f, 0f, 150, default(Color), 1.2f);
            ...
            if (accelerated)
            {
                for (int i = 0; i < 3; i++) // spawn 3 extra cyan dust per tick
                {
                    ...
                    int dust = Dust.NewDust(Projectile.position + offset, 1, 1, DustID.BlueTorch, 0f, 0f, 150, default(Color), 1.2f);
        ...
        {
            // Semi-transparent cyan glow like LichFlare
            return new Color(0, 255, 255, 150) * 0.8f;
        }
